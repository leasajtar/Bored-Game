...
public class ProfileController {
    ...
    public String publicProfile(@PathVariable String username, HttpSession session, Model model) {
        Optional<User> userOpt = usersRepos.findByUsername(username);
        if (userOpt.isEmpty()) {
        ...
        // Ako gledaš vlastiti profil, preusmjeri na /profile
